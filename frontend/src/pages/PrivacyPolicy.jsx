        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 text-slate-700 text-sm sm:text-base">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>Documents: PDF files you upload for processing</li>
              <li>Extracted data: information parsed from your documents (amounts, dates, suppliers, etc.)</li>
              <li>Usage data: login timestamps, document processing status</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              We process your data to provide the document extraction service, manage your account, and improve our platform. The legal basis is the performance of our contract with you and our legitimate interest in operating the service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We use essential cookies for authentication (session, refresh token). These are necessary for the service to function and do not require consent. If we introduce non-essential cookies (e.g. analytics), we will inform you and obtain your consent.
            </p>
          </section>
